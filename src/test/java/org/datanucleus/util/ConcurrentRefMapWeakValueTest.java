...
/**
 * Tests the functionality of ConcurrentReferenceHashMap with WEAK values.
 */
public class ConcurrentRefMapWeakValueTest extends ReferenceValueMapTestCase
{
    public ConcurrentRefMapWeakValueTest(String name)
    {
        super(name);
    }
