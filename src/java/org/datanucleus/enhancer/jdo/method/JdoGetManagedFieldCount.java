...
public class JdoGetManagedFieldCount extends ClassMethod
{
    ...
    {
        return new JdoGetManagedFieldCount(enhancer, enhancer.getNamer().getGetManagedFieldCountMethodName(),
     ...
     */
    public JdoGetManagedFieldCount(ClassEnhancer enhancer, String name, int access, 
