...
{
    public static JdoIsPersistent getInstance(ClassEnhancer enhancer)
    {
        return new JdoIsPersistent(enhancer, enhancer.getNamer().getIsPersistentMethodName(),
     ...
     */
    public JdoIsPersistent(ClassEnhancer enhancer, String name, int access, Object returnType, Object[] argTypes, String[] argNames)
    {
