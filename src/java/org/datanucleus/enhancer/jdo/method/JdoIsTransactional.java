...
public class JdoIsTransactional extends JdoIsXXX
{
    ...
    {
        return new JdoIsTransactional(enhancer, enhancer.getNamer().getIsTransactionalMethodName(), 
     ...
     */
    public JdoIsTransactional(ClassEnhancer enhancer, String name, int access, Object returnType, Object[] argTypes, String[] argNames)
    {
