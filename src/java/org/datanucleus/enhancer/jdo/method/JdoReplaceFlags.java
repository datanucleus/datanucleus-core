...
{
    public static JdoReplaceFlags getInstance(ClassEnhancer enhancer)
    {
        return new JdoReplaceFlags(enhancer, enhancer.getNamer().getReplaceFlagsMethodName(),
     ...
     */
    public JdoReplaceFlags(ClassEnhancer enhancer, String name, int access, 
