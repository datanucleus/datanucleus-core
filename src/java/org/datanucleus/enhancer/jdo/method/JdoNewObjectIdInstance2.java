...
public class JdoNewObjectIdInstance2 extends ClassMethod
{
    ...
    {
        return new JdoNewObjectIdInstance2(enhancer, enhancer.getNamer().getNewObjectIdInstanceMethodName(),
     ...
     */
    public JdoNewObjectIdInstance2(ClassEnhancer enhancer, String name, int access, 
