...
{
    public static JdoCopyKeyFieldsToObjectId2 getInstance(ClassEnhancer enhancer)
    {
        return new JdoCopyKeyFieldsToObjectId2(enhancer, enhancer.getNamer().getCopyKeyFieldsToObjectIdMethodName(),
     ...
     */
    public JdoCopyKeyFieldsToObjectId2(ClassEnhancer enhancer, String name, int access, 
