...
public class JdoIsNew extends JdoIsXXX
{
    ...
    {
        return new JdoIsNew(enhancer, enhancer.getNamer().getIsNewMethodName(), Opcodes.ACC_PUBLIC | Opcodes.ACC_FINAL,
     ...
     */
    public JdoIsNew(ClassEnhancer enhancer, String name, int access, Object returnType, Object[] argTypes, String[] argNames)
    {
