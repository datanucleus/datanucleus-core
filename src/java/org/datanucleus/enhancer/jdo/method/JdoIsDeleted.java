...
public class JdoIsDeleted extends JdoIsXXX
{
    ...
    {
        return new JdoIsDeleted(enhancer, enhancer.getNamer().getIsDeletedMethodName(),
     ...
     */
    public JdoIsDeleted(ClassEnhancer enhancer, String name, int access, Object returnType, Object[] argTypes, String[] argNames)
    {
