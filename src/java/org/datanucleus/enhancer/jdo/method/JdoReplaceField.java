...
public class JdoReplaceField extends ClassMethod
{
    ...
    {
        return new JdoReplaceField(enhancer, enhancer.getNamer().getReplaceFieldMethodName(), Opcodes.ACC_PUBLIC,
     ...
     */
    public JdoReplaceField(ClassEnhancer enhancer, String name, int access, 
