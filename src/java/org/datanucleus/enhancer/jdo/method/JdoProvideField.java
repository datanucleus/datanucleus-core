...
public class JdoProvideField extends ClassMethod
{
    ...
    {
        return new JdoProvideField(enhancer, enhancer.getNamer().getProvideFieldMethodName(), Opcodes.ACC_PUBLIC,
     ...
     */
    public JdoProvideField(ClassEnhancer enhancer, String name, int access, 
