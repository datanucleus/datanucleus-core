...
{
    public static JdoGetTransactionalObjectId getInstance(ClassEnhancer enhancer)
    {
        return new JdoGetTransactionalObjectId(enhancer, enhancer.getNamer().getGetTransactionalObjectIdMethodName(), 
     ...
     */
    public JdoGetTransactionalObjectId(ClassEnhancer enhancer, String name, int access, 
    ...
    public void execute()
    {
        ...
        visitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, getNamer().getStateManagerAsmClassName(),
            "getTransactionalObjectId", "(" + getNamer().getPersistableDescriptor() + ")" + EnhanceUtils.CD_Object);
        Label l2 = new Label();
