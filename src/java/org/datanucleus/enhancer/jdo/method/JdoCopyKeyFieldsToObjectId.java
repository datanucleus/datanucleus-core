...
{
    public static JdoCopyKeyFieldsToObjectId getInstance(ClassEnhancer enhancer)
    {
        return new JdoCopyKeyFieldsToObjectId(enhancer, enhancer.getNamer().getCopyKeyFieldsToObjectIdMethodName(),
     ...
     */
    public JdoCopyKeyFieldsToObjectId(ClassEnhancer enhancer, String name, int access, 
