...
{
    public static JdoPreSerialize getInstance(ClassEnhancer enhancer)
    {
        return new JdoPreSerialize(enhancer, enhancer.getNamer().getPreSerializeMethodName(),
     ...
     */
    public JdoPreSerialize(ClassEnhancer enhancer, String name, int access, 
