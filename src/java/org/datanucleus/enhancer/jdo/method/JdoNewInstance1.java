...
public class JdoNewInstance1 extends ClassMethod
{
    ...
    {
        return new JdoNewInstance1(enhancer, enhancer.getNamer().getNewInstanceMethodName(), Opcodes.ACC_PUBLIC,
     ...
     */
    public JdoNewInstance1(ClassEnhancer enhancer, String name, int access, 
