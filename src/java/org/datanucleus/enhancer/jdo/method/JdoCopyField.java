...
{
    public static JdoCopyField getInstance(ClassEnhancer enhancer)
    {
        return new JdoCopyField(enhancer, enhancer.getNamer().getCopyFieldMethodName(), Opcodes.ACC_PROTECTED | Opcodes.ACC_FINAL,
     ...
     */
    public JdoCopyField(ClassEnhancer enhancer, String name, int access, 
