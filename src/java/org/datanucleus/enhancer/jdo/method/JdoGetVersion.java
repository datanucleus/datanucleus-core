...
public class JdoGetVersion extends ClassMethod
{
    ...
    {
        return new JdoGetVersion(enhancer, enhancer.getNamer().getGetVersionMethodName(), Opcodes.ACC_PUBLIC | Opcodes.ACC_FINAL,
     ...
     */
    public JdoGetVersion(ClassEnhancer enhancer, String name, int access, 
