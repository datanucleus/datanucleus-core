...
{
    public static JdoReplaceFields getInstance(ClassEnhancer enhancer)
    {
        return new JdoReplaceFields(enhancer, enhancer.getNamer().getReplaceFieldsMethodName(),
     ...
     */
    public JdoReplaceFields(ClassEnhancer enhancer, String name, int access, 
