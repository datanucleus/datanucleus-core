...
public abstract class AbstractStoreManager extends PropertyStore implements StoreManager
{
    ...
    /**
     * Utility to return a managed connection not tied to any ExecutionContext. This returns a connection from
     * the secondary DataSource (e.g. javax.jdo.option.connectionFactory2Name), if it is provided.
     * Typically called for getting a connection for use with schema operations, or for accessing sequences.
