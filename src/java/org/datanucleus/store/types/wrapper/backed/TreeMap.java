 ...
 */
public class TreeMap extends org.datanucleus.store.types.wrapper.TreeMap implements BackedSCO
{
    ...
    public TreeMap(ObjectProvider op, AbstractMemberMetaData mmd)
    {
            ...
            mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.TreeMap.class);
        }
