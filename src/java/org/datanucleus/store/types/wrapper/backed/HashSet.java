 ...
 */
public class HashSet extends org.datanucleus.store.types.wrapper.HashSet implements BackedSCO
{
    ...
    public HashSet(ObjectProvider op, AbstractMemberMetaData mmd)
    {
            ...
            mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.HashSet.class);
        }
