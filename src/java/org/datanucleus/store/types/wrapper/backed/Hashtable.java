...
Contributors:
    ...
**********************************************************************/
package org.datanucleus.store.types.wrapper.backed;
 ...
 */
public class Hashtable extends org.datanucleus.store.types.wrapper.Hashtable implements BackedSCO
{
    ...
    public Hashtable(ObjectProvider op, AbstractMemberMetaData mmd)
    {
            ...
            mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.Hashtable.class);
        }
    ...
    public Collection values()
    {
        ...
        {
            return new org.datanucleus.store.types.wrapper.backed.Collection(ownerOP, ownerMmd, true, backingStore.valueCollectionStore());
        }
