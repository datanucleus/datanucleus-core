 ...
 */
public class LinkedList extends org.datanucleus.store.types.wrapper.LinkedList implements BackedSCO
{
    ...
    public LinkedList(ObjectProvider ownerOP, AbstractMemberMetaData mmd)
    {
            ...
            mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.LinkedList.class);
        }
