 ...
 */
public class SortedSet extends org.datanucleus.store.types.wrapper.SortedSet implements BackedSCO
{
        ...
        if (c != null)
        {
            ...
            else if (forUpdate)
            {
                ...
                if (useCache)
                {
                    ...
                    java.util.SortedSet delegateCopy = new java.util.TreeSet(delegate);
