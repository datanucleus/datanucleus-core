 ...
 */
public class Stack extends org.datanucleus.store.types.wrapper.Stack implements BackedSCO
{
    ...
    public Stack(ObjectProvider op, AbstractMemberMetaData mmd)
    {
            ...
            mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.Stack.class);
        }
