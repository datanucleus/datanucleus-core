 ...
 */
public class Vector extends org.datanucleus.store.types.wrapper.Vector implements BackedSCO
{
    ...
    public Vector(ObjectProvider op, AbstractMemberMetaData mmd)
    {
            ...
            mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.Vector.class);
        }
