 ...
 */
public class LinkedHashSet extends org.datanucleus.store.types.wrapper.LinkedHashSet implements BackedSCO
{
    ...
    public LinkedHashSet(ObjectProvider op, AbstractMemberMetaData mmd)
    {
            ...
            mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.LinkedHashSet.class);
        }
