 ...
 */
public class Properties extends org.datanucleus.store.types.wrapper.Properties implements BackedSCO
{
    ...
    public Properties(ObjectProvider op, AbstractMemberMetaData mmd)
    {
            ...
            mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            ((BackedSCOStoreManager)ec.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.Map.class);
        }
