...
public class Set<E> extends org.datanucleus.store.types.wrappers.Set<E> implements BackedSCO
{
     ...
     */
    public Set(DNStateManager sm, AbstractMemberMetaData mmd)
    {
    ...
    public Set(DNStateManager ownerSM, AbstractMemberMetaData mmd, boolean allowNulls, SetStore backingStore)
    {
        ...
        else if (!SCOUtils.collectionHasSerialisedElements(mmd) && mmd.getPersistenceModifier() == FieldPersistenceModifier.PERSISTENT)
        {
            ...
            this.backingStore = (SetStore)((BackedSCOStoreManager)ownerSM.getStoreManager()).getBackingStoreForField(clr, mmd, java.util.Set.class);
        }
