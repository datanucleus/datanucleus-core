 ...
 * Utilises a String form of the style "mydomain.MyClass-3258"; this is a form similar to OpenJPA/Kodo.
 */
public class DatastoreIdImplKodo implements java.io.Serializable, DatastoreId, Comparable
{
     ...
     * @param str the string representation of the DatastoreId
