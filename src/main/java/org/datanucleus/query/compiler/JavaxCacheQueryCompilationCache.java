 ...
 */
public class JavaxCacheQueryCompilationCache implements QueryCompilationCache
{
    /** The cache to use. */
    ...
    public JavaxCacheQueryCompilationCache(NucleusContext nucleusCtx)
    {
        ...
        if (cacheName == null)
        {
            NucleusLogger.CACHE.warn("No 'datanucleus.cache.queryCompilation.cacheName' specified so using name of 'DataNucleus-QueryCompilation'");
