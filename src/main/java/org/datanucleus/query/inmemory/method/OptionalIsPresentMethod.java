 ...
 */
public class OptionalIsPresentMethod implements InvocationEvaluator
{
    /* (non-Javadoc)
    ...
    public Object evaluate(InvokeExpression expr, Object invokedValue, InMemoryExpressionEvaluator eval)
    {
        ...
        else if (invokedValue instanceof Optional)
        {
            result = ((Optional)invokedValue).isPresent() ? Boolean.TRUE : Boolean.FALSE;
        }
        else
        {
